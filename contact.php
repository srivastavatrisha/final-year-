                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">521/86  Kha Narayan Prasad Marg Bada Chandganj , Lucknow</span> <br>
                                ...
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="d-table text-white">6386676234</span>
										<span class="text-white">+91 89339 46264 </span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1">
								</i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Address</h5>
										<span class="d-table text-white">srivastavatrisha914@gmail.com</span>
										<span class="text-white">srivastavatrisha914@gmail.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
